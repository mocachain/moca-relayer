...
import (
	...
	"github.com/mocachain/moca-relayer/app"
...
func printUsage() {
	fmt.Print("usage: ./moca-relayer --config-type local --config-path configFile\n")
	fmt.Print("usage: ./moca-relayer --config-type aws --aws-region awsRegin --aws-secret-key awsSecretKey\n")
}

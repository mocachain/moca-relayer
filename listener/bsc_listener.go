...
func NewBSCListener(cfg *config.Config, bscExecutor *executor.BSCExecutor, gnfdExecutor *executor.MocaExecutor, dao *dao.DaoManager, ms *metric.MetricService) *BSCListener {

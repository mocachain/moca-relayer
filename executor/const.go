...
var (
	BSCBalanceThreshold = big.NewInt(1) // when relayer is lower than 1moca, it should try to claim rewards
	MOCADecimal         = big.NewInt(1000000000000000000)

	BSCRewardThreshold = big.NewInt(100000000000000000) // if reward is lower than 0.1 moca, it will not be claimed.
)
